package com.admin.categories.edit_delete.adapter
...
class ListAdapterCategories (var mContext:Context, var teacherList:List<Teacher> ):
    RecyclerView.Adapter<ListAdapterCategories.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        ...
        var v = infalter.inflate(R.layout.item_categories_show_data, parent, false)
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.delete.setOnCheckedChangeListener { checkBox, isChecked ->
            //.. delete form fireStore
                db.collection("category").document(newList.id.toString())
                    .delete()
            ...
            val applesQuery: Query =
                ref.child("categories").orderByChild("name").equalTo(newList.name)
